 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Organic Origin
...
add_action( 'tgmpa_register', 'profile_lite_register_required_plugins' );
 ...
 */
function profile_lite_register_required_plugins() {
	/*
	 ...
	 */
	$config = array(
		'id'           => 'profile-lite',          // Unique ID for hashing notices for multiple instances of TGMPA.
